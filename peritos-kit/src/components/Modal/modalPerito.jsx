...
export default function ModalPerito({ selected, onClose, onDecision }) {
    ...
    const [postVisitDeadline, setPostVisitDeadline] = useState(null)
        ...
        >
            {selected && (
                <div style={{ display: "grid", gap: 12 }}>
                    ...
                    {/* Vista DETALLE si ya está finalizado */}
                    {selected.estado === "Finalizado" && (
                        <div className="panel">
                            ...
                            {/* Render del video estable */}
                            {videoUrl && (
                                <div style={{ marginTop: 12 }}>
                                    <strong>Video:</strong>
                                    <video
                                        key={videoUrl}  // asegura que se refresque solo cuando cambia de verdad
                                        controls
                                        width="100%"
                                        src={videoUrl}
                                    />
