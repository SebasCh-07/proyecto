...
export default function RequerimientoDetalle() {
  ...
  // Helpers para soportar Blob/File o rutas estáticas
  const toObjectUrl = (maybeBlobOrPath) => {
    if (!maybeBlobOrPath) return null;
    if (typeof maybeBlobOrPath === 'string') return maybeBlobOrPath;
    try {
      return URL.createObjectURL(maybeBlobOrPath);
    } catch (_) {
      return null;
    }
  };
  ...
  return (
    <div className="card" style={{
      ...
      <div className="panel" style={{ marginBottom: isMobile ? "16px" : "24px", padding: isMobile ? "16px" : "24px", backgroundColor: "#f8f9fa", border: "1px solid #e9ecef", borderRadius: "12px" }}>
        <h3 style={{ marginBottom: isMobile ? "16px" : "20px", color: "#005eff", fontSize: isMobile ? "18px" : "22px", borderBottom: "2px solid #005eff", paddingBottom: "12px" }}>
          Detalles del Requerimiento
        </h3>
        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: isMobile ? "12px" : "20px" }}>
          <div style={{ padding: isMobile ? "12px" : "16px", backgroundColor: "white", borderRadius: "8px", border: "1px solid #e2e8f0" }}>
      ...
      <div className="panel" style={{ marginBottom: 16 }}>
          ...
          <div style={{ display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column" }}>
            {req.gps && !req.gps.error ? (
              <iframe
                ...
                style={{ border: 0, marginTop: "20px", borderRadius: "12px", boxShadow: "0 2px 8px rgba(0,0,0,0.1)", maxWidth: isMobile ? "360px" : "90%" }}
                loading="lazy"
        ...
        {req.video && (
          <div style={{ marginBottom: 16 }}>
            ...
            <div style={{ display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column" }}>
              <video
                key={toObjectUrl(req.video) || 'video'}
                controls
                width={isMobile ? "100%" : "90%"}
                style={{ borderRadius: "12px", marginTop: 20, boxShadow: "0 2px 8px rgba(0,0,0,0.1)", maxWidth: isMobile ? "360px" : "90%" }}
                src={toObjectUrl(req.video) || undefined}
              />
            </div>
          </div>
        )}
        ...
        {req.pdf && (
          <div style={{ marginBottom: 16 }}>
            ...
            <div style={{ marginTop: 8 }}>
              <a
                href={toObjectUrl(req.pdf) || undefined}
                target="_blank"
                rel="noopener noreferrer"
                style={{ color: "#005eff", textDecoration: "none", padding: "8px 16px", backgroundColor: "#eaf1ff", borderRadius: "8px", display: "inline-block" }}
              >
                Ver Informe PDF
              </a>
            </div>
